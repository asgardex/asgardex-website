    ...
    <footer className="p-10 max-w-[1300px] m-auto flex flex-col items-center justify-center mt-10">
      ...
      <nav className="w-full flex flex-col md:flex-row items-start lg:items-center justify-between">
        <div className="w-full mb-5 md:w-1/2">
          ...
          <p>
            Stay updated with the latest from Asgardex. Follow us on X, join the conversation on
            Discord, and explore our code on GitHub. For detailed insights and updates, don’t forget to
            check out also <Link href="https://twitter.com/THORChain" target="_blank" className="text-asgardex-hyperlink">THORChain X</Link> and <Link href="https://www.mayaprotocol.com/" target="_blank" className="text-asgardex-hyperlink">MayaProtocol</Link>.
          </p>
          <p>
            The Asgardex Team oversees the operation of this website. Our repository is maintained on Github under <Link href="https://github.com/asgardex/asgardex-website" target="_blank" className="text-asgardex-hyperlink">asgardex-website</Link>, where all code is openly available.
          </p>
        </div>
