    ...
    <main className='flex min-h-screen flex-col items-center pt-20 lg:gap-y-20'>
      ...
      <section className='flex flex-col w-full items-center justify-center px-6 md:px-16 lg:px-8'>
        <div className='max-w-[1000px] text-center flex flex-col items-center py-16'>
          ...
          <Image className='my-14' src={'/wallets-management-home.avif'} alt='' width={1000} height={200} />
          <div className='pt-5 grid grid-cols-2 lg:grid-cols-3 gap-10'>
            <div className='text-left'>
              <h4 className='text-asgardex-dark-1000 font-bold text-sm lg:text-lg'>Local Wallets</h4>
              <h5 className='text-asgardex-dark-1000 font-medium text-sm lg:text-lg'>Create and manage locally.</h5>
            </div>
            <div className='text-left'>
              <h4 className='text-asgardex-dark-1000 font-bold text-sm lg:text-lg'>Secret Phrase</h4>
              <h5 className='text-asgardex-dark-1000 font-medium text-sm lg:text-lg'>Load wallet with a phrase.</h5>
            </div>
            <div className='text-left'>
              <h4 className='text-asgardex-dark-1000 font-bold text-sm lg:text-lg'>Ledger Support</h4>
              <h5 className='text-asgardex-dark-1000 font-medium text-sm lg:text-lg'>Integrated with Ledger devices.</h5>
            </div>
            <div className='text-left'>
              <h4 className='text-asgardex-dark-1000 font-bold text-sm lg:text-lg'>User-Friendly</h4>
              <h5 className='text-asgardex-dark-1000 font-medium text-sm lg:text-lg'>Effortless navigation and usage.</h5>
            </div>
            <div className='text-left'>
              <h4 className='text-asgardex-dark-1000 font-bold text-sm lg:text-lg'>Earn interest</h4>
              <h5 className='text-asgardex-dark-1000 font-medium text-sm lg:text-lg'>Also in native assets like BTC, DOGE, BCH...</h5>
            </div>
            <div className='text-left'>
              <h4 className='text-asgardex-dark-1000 font-bold text-sm lg:text-lg'>Node manage</h4>
      ...
      <section className='flex flex-col w-full items-center justify-center px-6 md:px-16 lg:px-8'>
        <div className='max-w-[1085px] flex flex-col lg:flex-row text-center items-center justify-around py-16 gap-x-20'>
          ...
          <div className='w-full flex items-center justify-center'>
            <Image src={'/earn-interest-home.avif'} alt='' width={420} height={420} />
          </div>
        </div>
      </section>
      ...
      <section className='flex flex-col w-full items-center justify-center px-6 md:px-16 lg:px-8'>
        <div className='max-w-[1085px] flex flex-col lg:flex-row-reverse text-center items-center justify-around py-16 gap-x-20'>
          ...
          <div className='w-full flex items-center justify-center'>
            <Image src={'/pools-home.avif'} alt='' width={500} height={500} />
          </div>
        </div>
      </section>
      ...
      <section className='flex flex-col w-full items-center justify-center px-6 md:px-16 lg:px-8'>
        <div className='max-w-[1000px] flex flex-col items-center text-center'>
          <div className='flex flex-col items-center'>
            ...
            <p className='text-sm md:text-lg lg:text-xl font-normal mb-8'>
              Not sure what Asgardex can do for you? Watch our informative videos, showcasing the application&apos;s features and user-friendly interface.
            </p>
          </div>
          <div className='aspect-video w-full'>
          ...
          <div className='max-w-[1085px] text-center py-16 m-auto'>
            <div className='pt-5 grid grid-cols-1 lg:grid-cols-3 gap-10'>
              <div className='m-auto w-1/2 lg:w-full text-left'>
                ...
                <h4 className='mt-4 text-md md:text-2xl font-bold'>Decentralization</h4>
                <p className='mt-3 text-xs md:text-base font-normal'>Avoids web apps, uses public servers, and is open-source to prevent
              ...
              <div className='m-auto w-1/2 lg:w-full text-left'>
                ...
                <h4 className='mt-4 text-md md:text-2xl font-bold'>Censorship Resistance</h4>
                <p className='mt-3 text-xs md:text-base font-normal'>The installer can be easily distributed and used without
              ...
              <div className='m-auto w-1/2 lg:w-full text-left'>
                ...
                <h4 className='mt-4 text-md md:text-2xl font-bold'>Security</h4>
                <p className='mt-3 text-xs md:text-base font-normal'>Developed and maintained by the community, reducing the risk of errors and fund loss.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className='flex flex-col w-full items-center justify-center px-6 md:px-16 lg:px-8'>
        <div className='max-w-[1085px] text-center flex flex-col items-center py-16'>
          ...
          <p className='text-sm md:text-lg lg:text-xl font-normal mb-8'>
            Explore the future with us. Our roadmap teases exciting developments like loan services, order book trading, and leveraged futures. Stay tuned for what&apos;s coming next in Asgardex&apos;s journey.
          </p>
          <div className='pt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10'>
            <div className='flex flex-row items-start'>
              <div className='mr-4'>
                <Image src={'/loans-logo.avif'} alt='' width={32} height={32} />
              </div>
              <div className='text-left'>
                <h4 className='text-asgardex-dark-1000 text-lg font-bold mb-2'>Loans Feature</h4>
                <h5 className='text-asgardex-dark-1000 text-sm font-medium'>Innovative loan options for all</h5>
              </div>
            </div>
            <div className='flex flex-row items-start'>
              <div className='mr-4'>
                <Image src={'/order-books-logo.avif'} alt='' width={32} height={32} />
              </div>
              <div className='text-left'>
                <h4 className='text-asgardex-dark-1000 text-lg font-bold mb-2'>Order Books</h4>
                <h5 className='text-asgardex-dark-1000 text-sm font-medium'>Efficient order book trading methods</h5>
              </div>
            </div>
            <div className='flex flex-row items-start'>
              <div className='mr-4'>
                <Image src={'/base-trading-logo.avif'} alt='' width={32} height={32} />
              </div>
              <div className='text-left'>
                <h4 className='text-asgardex-dark-1000 text-lg font-bold mb-2'>Based Trading</h4>
                <h5 className='text-asgardex-dark-1000 text-sm font-medium'>Leveraged futures trading simplified</h5>
              </div>
            </div>
            <div className='flex flex-row items-start'>
              <div className='mr-4'>
            ...
            <div className='flex flex-row items-start'>
              <div className='mr-4'>
                <Image src={'/trading-futures-logo.avif'} alt='' width={32} height={32} />
              </div>
              <div className='text-left'>
                <h4 className='text-asgardex-dark-1000 text-lg font-bold mb-2'>Trading Features</h4>
                <h5 className='text-asgardex-dark-1000 text-sm font-medium'>Trade efficiently with Roadmap</h5>
              </div>
            </div>
            <div className='flex flex-row items-start'>
              <div className='mr-4'>
                <Image src={'/future-implementations-logo.avif'} alt='' width={32} height={32} />
              </div>
              <div className='text-left'>
                <h4 className='text-asgardex-dark-1000 text-lg font-bold mb-2'>Future Implementations</h4>
                <h5 className='text-asgardex-dark-1000 text-sm font-medium'>Exciting features coming soon</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='max-w-[900px] text-center py-16'>
          ...
          <div className='w-full'>
            <div className='flex flex-row items-start w-full justify-between py-6'>
              ...
              <div className='text-left w-2/3'>
                <h4 className='text-asgardex-dark-1000 text-lg font-bold mb-2'>Aspect One</h4>
                <h5 className='text-asgardex-dark-1000 text-sm md:text-xl font-normal'>Sign up and explore the Asgardex platform.</h5>
              </div>
            </div>
            <Divider />
          </div>
          <div className='w-full'>
            <div className='flex flex-row items-start w-full justify-between py-6'>
              ...
              <div className='text-left w-2/3'>
                <h4 className='text-asgardex-dark-1000 text-lg font-bold mb-2'>Aspect Two</h4>
                <h5 className='text-asgardex-dark-1000 text-sm md:text-xl font-normal'>Start comparing transaction costs with CEX.</h5>
              </div>
            </div>
            <Divider />
          </div>
          <div className='w-full'>
            <div className='flex flex-row items-start w-full justify-between py-6'>
              ...
              <div className='text-left w-2/3'>
                <h4 className='text-asgardex-dark-1000 text-lg font-bold mb-2'>Aspect Three</h4>
                <h5 className='text-asgardex-dark-1000 text-sm md:text-xl font-normal'>Experience lower slippage and start trading.</h5>
              </div>
            </div>
            <Divider />
          </div>
          <Button className='bg-asgardex-primary-500 font-medium text-lg rounded-lg px-16 py-6 mt-8'>
            Start Comparing
          </Button>
        </div>
      </section>
      ...
      <section className='flex flex-col w-full items-center justify-center px-6 md:px-16 lg:px-8'>
        <div className='max-w-[1085px] flex flex-col lg:flex-row text-center items-center justify-around py-16 gap-x-20'>
          <div className='w-full'>
            ...
            <Button as={Link} href='https://crypto-university.medium.com/' target='_blank' className='bg-asgardex-primary-500 font-medium text-lg rounded-lg px-16 py-6 my-10'>
              Start Learning
            </Button>
          </div>
      ...
      <section className='flex flex-col w-full items-center justify-center px-6 md:px-16 lg:px-8'>
        <div className='max-w-[1085px] flex flex-col lg:flex-row-reverse text-center items-center justify-around py-16 gap-x-20'>
          <div className='mb-10 lg:mb-0 w-full'>
            ...
            <Button as={Link} href='https://crypto-university.medium.com/' target='_blank' className='bg-asgardex-primary-500 font-medium text-lg rounded-lg px-16 py-6 mt-8'>
              Start Learning
            </Button>
          </div>
        ...
        <div className='max-w-[1085px] text-center py-28'>
          ...
          <div className='pt-5 grid grid-cols-2 lg:grid-cols-4 gap-10'>
            <div className='flex flex-col items-center justify-center'>
              ...
              <Link className='w-full' href={'https://discord.com/invite/XjV3Hnud'} target='_blank'>
